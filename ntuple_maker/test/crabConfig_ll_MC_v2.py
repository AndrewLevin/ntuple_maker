...
config.General.requestName = 'flattish_nuples_mc_v2_v51'
config.General.workArea = 'crab_projects'

config.section_("JobType")
config.JobType.pluginName = 'Analysis'
config.JobType.psetName = 'ntuple_maker/ntuple_maker/python/ConfFile_ll_mc_v2_cfg.py'
...
config.Data.outputDatasetTag = 'flattish_ntuples_mc_v2_v49'
