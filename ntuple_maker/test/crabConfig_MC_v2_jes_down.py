...
config.General.requestName = 'flattish_nuples_mc_v2_jes_down_v1401'
config.General.workArea = 'crab_projects'

config.section_("JobType")
config.JobType.pluginName = 'Analysis'
config.JobType.psetName = 'src/ntuple_maker/ntuple_maker/python/ConfFile_mc_v2_jes_down_cfg.py'
...
config.Data.outputDatasetTag = 'flattish_ntuples_mc_v2_jes_down_v1400'
