...
config.General.requestName = 'flattish_nuples_mc_v3_v80'
...
config.Data.inputDataset= '/WW_DoubleScattering_13TeV-pythia8/RunIISpring15MiniAODv2-74X_mcRun2_asymptotic_v2-v1/MINIAODSIM'
...
config.Data.outputDatasetTag = 'flattish_ntuples_mc_v3_v80'
