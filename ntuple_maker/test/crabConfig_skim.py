...
config.General.requestName = 'flattish_nuples_v17'
config.General.workArea = 'crab_projects'

config.section_("JobType")
config.JobType.pluginName = 'Analysis'
config.JobType.psetName = 'ntuple_maker/ntuple_maker/python/ConfFile_skim_cfg.py'
...
config.Data.publishDataName = 'flattish_ntuples_v17'
