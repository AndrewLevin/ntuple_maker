...
config.General.requestName = 'threeljj_flattish_nuples_mc_80X_v2_v800'
config.General.workArea = 'crab_projects'

config.section_("JobType")
config.JobType.pluginName = 'Analysis'
config.JobType.psetName = 'src/ntuple_maker/ntuple_maker/python/ConfFile_threeljj_mc_v2_cfg.py'
...
#config.Data.inputDataset = '/WZJJ_QCD_13TeV-madgraph-pythia8/RunIIFall15MiniAODv2-PU25nsData2015v1_76X_mcRun2_asymptotic_v12-v1/MINIAODSIM'
...
config.Data.outputDatasetTag = 'threeljj_flattish_ntuples_mc_80X_v2_v800'
