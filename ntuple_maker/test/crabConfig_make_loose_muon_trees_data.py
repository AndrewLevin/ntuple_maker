...
config.General.requestName = 'fr_muon_ntuples_data_v5006'
...
config.Data.outputDatasetTag = 'fr_muon_ntuples_data_v5000'
...
config.Site.blacklist = ["T2_US_Vanderbilt","T2_US_Florida"]
